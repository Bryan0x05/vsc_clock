...
To setup the Visual Studio Code enviroment for extension developement.
Put the given file in the "src" folder.

Run the developer extension enviroment as intstructed in the aforementioned link
and the clock should be active on startup on the right side of the status bar at the bottom.
